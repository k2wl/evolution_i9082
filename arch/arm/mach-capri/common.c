...
struct kona_freq_tbl kona_freq_tbl[] = {
	...
	FTBL_INIT(800000, PI_PROC_OPP_TURBO1),
	FTBL_INIT(1200000, PI_PROC_OPP_TURBO),
	FTBL_INIT(1334000, PI_PROC_OPP_TURBO),
	FTBL_INIT(1456000, PI_PROC_OPP_TURBO),
	FTBL_INIT(1526000, PI_PROC_OPP_TURBO),
	FTBL_INIT(1678000, PI_PROC_OPP_TURBO),
	FTBL_INIT(1797000, PI_PROC_OPP_TURBO),
#else
	FTBL_INIT(312000, PI_PROC_OPP_ECONOMY1),
	FTBL_INIT(550000, PI_PROC_OPP_NORMAL),
	FTBL_INIT(733333, PI_PROC_OPP_TURBO1),
	FTBL_INIT(1100000, PI_PROC_OPP_TURBO),
	FTBL_INIT(1250000, PI_PROC_OPP_TURBO),
	FTBL_INIT(1366000, PI_PROC_OPP_TURBO),
	FTBL_INIT(1478000, PI_PROC_OPP_TURBO),
#endif
#endif
};
