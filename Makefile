...
ARCH		?= arm
#CROSS_COMPILE	?= ~/kernel/tc/sm-4.10/bin/arm-eabi-
#CROSS_COMPILE	?= ~/kernel/tc/Linaro-4.10/bin/arm-eabi-
CROSS_COMPILE	?= ~/kernel/tc/linaro_4.9.1-2014.05/bin/arm-cortex_a9-linux-gnueabihf
